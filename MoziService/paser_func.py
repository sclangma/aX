...
def add_item_to_dic(dic, item, key):
    ...
    # add a condition to judge if there's a "strGuid" key in the item.     by aie
    # it filters the weather and reponse classes.  by aie
    # TODO: except for CWeather and CResponse, is there any other class not having "strGuid"? Need to be identified.
    if item.get("strGuid")==None :
        # print(item)
        return
    if ret:
